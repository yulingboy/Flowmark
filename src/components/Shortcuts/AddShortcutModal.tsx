    ...
    <Modal
      ...
      footer={
        <Space>
          ...
          <Button type="primary" onClick={handleSave} disabled={!url || !name}>
            {isEditMode ? '保存修改' : '保存'}
          </Button>
        </Space>
      }
      ...
      <div className="flex flex-col gap-4 py-4">
        <div className="flex items-center gap-4">
          ...
          <Input
            ...
            maxLength={1000}
            suffix={<span className="text-xs text-gray-400">{url.length}/1000</span>}
          />
          <Button onClick={handleFetchIcon} disabled={!url} loading={isLoading}>
            获取图标
          </Button>
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <Input
            ...
            placeholder="标签名称"
            maxLength={100}
            suffix={<span className="text-xs text-gray-400">{name.length}/100</span>}
          />
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <Input
            ...
            maxLength={200}
            suffix={<span className="text-xs text-gray-400">{description.length}/200</span>}
          />
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <Input
            value={iconUrl}
            onChange={(e) => { setIconUrl(e.target.value); setPreviewIcon(e.target.value); }}
            placeholder="请上传或粘贴标签图标地址"
          />
          <Button>
